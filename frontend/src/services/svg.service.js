export const svgService = {
  ...
  btnGoBackHeader: (
    <svg
      ...
      width="16"
      aria-hidden="true"
      className="Svg-sc-ytk21e-0 eNWijz IYDlXmBmmUKHveMzIPCF"
      viewBox="0 0 16 16"
      data-encore-id="icon"
    >
  ...
  activeSearch: (
    <svg
      ...
      width="24"
      aria-hidden="true"
      className="Svg-sc-ytk21e-0 haNxPq search-active-icon"
      viewBox="0 0 24 24"
      data-encore-id="icon"
    >
  ...
  likedSongIcon: (
    <svg
      ...
      viewBox="0 0 16 16"
      data-encore-id="icon"
      className="liked-song-icon haNxPq"
    >
